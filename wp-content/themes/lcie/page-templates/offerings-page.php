                    ...
                    <div class="offerings__team__grid__col">
                        <div class="grid">
                            <div class="offerings__team__grid__col__photo"
                                 style="background-image: url(<?php echo $value["photo"]; ?>)"></div>
                            <div class="offerings__team__grid__col__details">
                                ...
                                <div class="offerings__team__grid__col__details__contact">
                                    <a href="mailto:<?php echo $value["email"]; ?>"
                                       class="offerings__team__grid__col__details__contact__mail"><?php echo $value["email"]; ?></a>
                ...
                <?php if (have_rows('infrastructure')): while (have_rows('infrastructure')) : the_row();
                    ...
                    <div class="offerings__infrastructure__grid__col">
                        ...
                        <a href="<?php echo site_url(); ?>/contact"
                           class="offerings__infrastructure__grid__col__plan"><?php pll_e("Reserveren"); ?></a>
